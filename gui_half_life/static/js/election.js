$(function () {
    ...
    $.ajax({
        url: '/legislative_title_welcome_fetch',
        type: 'GET',
        success: function (response) {
            ...
            for (const k in response.data) {
                ...
                $("#welcome-fetch-title-ratio").append("<div class=\"col-lg-2 \">" +
                    ...
                    "                         src=\"static/images/legislative/" + k + ".jpg\"" +
    ...
    $.ajax({
        url: '/presidentielle_csa_transcript_duration',
        type: 'GET',
        success: function (response) {
            ...
            $("#presidentielle_csa_transcript_duration").html(key);
            $("#presidentielle_csa_transcript_duration").append(chart);
        }
    });
