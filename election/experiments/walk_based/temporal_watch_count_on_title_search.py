...
if __name__ == '__main__':
    ...
    if generate:
        ...
        for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
            ...
            candidate_dictionary = {c_: {b: 0 for b in set([a[2] for a in not_none_video_views if a[2] and a[2] != ""])} for
                                    c_ in
                                    Candidates.official}
    ...
    if plot:
        for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/walk_based/temporal_watch_count/temporal_watch_count_on_title_search" + file_name + "_" + ".png")
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/walk_based/temporal_watch_count/temporal_watch_count_on_title_search_ma7_" + file_name + ".png")
            plt.show()
