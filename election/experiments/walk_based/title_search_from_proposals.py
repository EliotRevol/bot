...
from utils.io import read_experiments, read_experiment_files, read_multi_folder
...
if __name__ == '__main__':
    ...
    for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
        ...
        video_titles = [exp['title'].lower() for e in experiments for exp in e if exp and exp['type'] == 'proposal']
