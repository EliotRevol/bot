...
def title_check(candidates_list, titles, experiment_type, plot_title=""):
    ...
    plt.savefig("../plots/title_search/" + file_name+ ".png")


if __name__ == '__main__':
    experiment_folder = ["14.01.2022", "07_01_2022"]
    for exp in [Experiments.WELCOME_WALK, Experiments.WELCOME_FETCH, Experiments.NATIONAL_NEWS_FETCH,
                Experiments.NATIONAL_NEWS_WALK]:
        experiments = read_multi_folder(experiment_folder, exp, ResultTypes.JSON,data_folder="../data")
        video_titles = [exp['title'].lower() for e in experiments for exp in e if e]
