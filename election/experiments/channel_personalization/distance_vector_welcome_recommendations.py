...
if __name__ == '__main__':
    ...
    # experiments = read_multi_folder("*", experiment_name, ResultTypes.JSON,"/srv/tempdd/ayesilka/data/")
    #
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig("../../plots/channel_personalization/cosine_del1_welcome.png")
    ...
    plt.savefig("../../plots/channel_personalization/cosine_del1_welcome_kde_allhops.png")
    ...
    plt.tight_layout()
    plt.savefig("../../plots/channel_personalization/cosine_del1_welcome_kde_no0hop.png")
