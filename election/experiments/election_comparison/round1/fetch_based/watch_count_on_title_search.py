    ...
    if generate:
        ...
        for exp in [Experiments.WELCOME_FETCH, Experiments.NATIONAL_NEWS_FETCH]:
            ...
            for month, folders in tqdm.tqdm(Folders.Round1.folders_dict.items()):
                ...
                dump_pickle("watch_count_title_search_" + exp.lower() + "_" + month + ".pkl", candidate_dictionary)
    plot = True
    if plot:
        for exp in [Experiments.WELCOME_FETCH, Experiments.NATIONAL_NEWS_FETCH]:
            print(exp)
            ...
            for month, folders in Folders.Round1.folders_dict.items():
                ...
                candidate_dictionary = read_pickle("watch_count_title_search_" + exp.lower() + "_" + month + ".pkl")
                ...
                plt.tight_layout()
                plt.savefig(
                    "../../../../plots/election_comparison/round1/fetch_based/watch_count_title_search_" + file_name + "_" + month + ".png")
