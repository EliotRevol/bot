...
from utils.io import read_multi_folder, dump_pickle, read_pickle, read_json
...
if __name__ == '__main__':
    ...
    if plot:
        for exp in [
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/fetch_based/watch_count_per_upload_date/box_plot_ratio_candidate_polls" + str(
                    exp).lower() + ".png")
            # plt.show()
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/fetch_based/watch_count_per_upload_date/box_plot_ratio_candidate_polls_withwelcome" + str(
                    exp).lower() + ".png")
