...
if __name__ == '__main__':
    ...
    if generation:
        ...
        for exp in [Experiments.WELCOME_FETCH,
            ...
            author_json=[{a2['url']: a2['author'] for a2 in f} for f in
             json
             ]
            ...
            dump_pickle("csa_fetches_title_per_tv_1_01__13_02" + str(exp) + ".pkl", normalized_tv_dict)

    plot = True
    if plot:
        for exp in [Experiments.WELCOME_FETCH,
                    Experiments.NATIONAL_NEWS_FETCH]:
            normalized_tv_dict = read_pickle("csa_fetches_title_per_tv_1_01__13_02" + str(exp) + ".pkl")
            for channels in normalized_tv_dict.keys():
                ...
                plt.xticks(rotation=90)
                plt.tight_layout()
                plt.savefig("../../plots/csa/fetches_channels_title/" + str(exp.lower()) + "/" + channels + ".png")
                plt.cla()
