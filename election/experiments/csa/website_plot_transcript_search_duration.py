...
if __name__ == '__main__':
    ...
    experiments_json = read_multi_folder(experiment_folder, Experiments.WELCOME_WALK, ResultTypes.TRANSCRIPT,
    ...
    dump_pickle(
        f"transcript_duration_csa_dict_01-01__13-02_{int(datetime.datetime.timestamp(datetime.datetime.now()))}.pkl",
        csa_dict)
