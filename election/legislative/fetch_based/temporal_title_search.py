...
if __name__ == '__main__':
    ...
    if generate:
        ...
        for exp in [Experiments.WELCOME_FETCH, Experiments.NATIONAL_NEWS_FETCH]:
            ...
            dump_pickle("temporal_title_search_" + exp.lower() + "_" + partySynonymTypeStr + ".pkl",
    ...
    if plot:
        for exp in [Experiments.WELCOME_FETCH, Experiments.NATIONAL_NEWS_FETCH]:
            ...
            candidate_dictionary = read_pickle(
                "temporal_title_search_" + exp.lower() + "_" + partySynonymTypeStr + ".pkl")
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/legislative/fetch_based/temporal_title_search/temporal_title_search_" + file_name + "_" + partySynonymTypeStr + ".png")
            dump_json(
                "../../plots/legislative/fetch_based/temporal_title_search/temporal_title_search_" + file_name + "_" + partySynonymTypeStr + ".json",
                candidate_dictionary)
            df = pd.DataFrame.from_dict(candidate_dictionary)
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/legislative/fetch_based/temporal_title_search/temporal_title_search_ma7_" + file_name + "_" + partySynonymTypeStr + ".png")
    ...
    if polls_comparison:
        for exp in [Experiments.WELCOME_FETCH, Experiments.NATIONAL_NEWS_FETCH]:
            ...
            plt.savefig(
                "../../plots/legislative/fetch_based/temporal_title_search/temporal_title_search_vs_polls_" + file_name + "_" + partySynonymTypeStr + ".png")
            # ----- corr mae etc ---
