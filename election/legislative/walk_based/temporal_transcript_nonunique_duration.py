...
if __name__ == '__main__':
            ...
            for candidate, snonyms in tqdm.tqdm(partySynonymType.items()):
                ...
                for text, date in experiments_json:
                    ...
                    for t in text['transcript']:
                        if multi_check_with_accent([candidate] + snonyms, t['text'].lower()):
                            candidate_dictionary[candidate][date] += t['duration']

            dump_pickle("temporal_transcript_nonunique_duration_" + exp.lower() + "_" + partySynonymTypeStr + ".pkl",
                        candidate_dictionary)
    plot = True
    if plot:
        for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
            ...
            candidate_dictionary = read_pickle(
                "temporal_transcript_nonunique_duration_" + exp.lower() + "_" + partySynonymTypeStr + ".pkl")
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/legislative/walk_based/temporal_transcript_nonunique_duration/temporal_transcript_nonunique_duration_" + file_name + "_" + partySynonymTypeStr + ".png")
            dump_json(
                "../../plots/legislative/walk_based/temporal_transcript_nonunique_duration/temporal_transcript_nonunique_duration_" + file_name + "_" + partySynonymTypeStr + ".json",
                candidate_dictionary)
            df = pd.DataFrame.from_dict(candidate_dictionary)
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/legislative/walk_based/temporal_transcript_nonunique_duration/temporal_transcript_nonunique_duration_ma7_" + file_name + "_" + partySynonymTypeStr + ".png")
            # plt.show()
    ...
    if polls_comparison:
        for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
            ...
            plt.savefig(
                "../../plots/legislative/walk_based/temporal_transcript_nonunique_duration/temporal_transcript_nonunique_duration_vs_polls_" + file_name + "_" + partySynonymTypeStr + ".png")
            # ----- corr mae etc ---
