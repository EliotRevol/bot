...
if __name__ == '__main__':
    ...
    if generate:
        ...
        for exp in [ Experiments.NATIONAL_NEWS_WALK]: #TODO add Experiments.WELCOME_WALK,
            print(exp)
            ...
            for candidate, snonyms in tqdm.tqdm(partySynonymType.items()):
                ...
                for text in not_none_video_views:
                    if multi_check_with_accent([candidate] + snonyms, text[0].lower()):
                        candidate_dictionary[candidate][text[2]] += text[1]

            dump_pickle("temporal_watch_count_" + exp.lower() + "_" + partySynonymTypeStr + ".pkl",
    ...
    if plot:
        for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
            ...
            candidate_dictionary = read_pickle(
                "temporal_watch_count_" + exp.lower() + "_" + partySynonymTypeStr + ".pkl")
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/legislative/walk_based/temporal_watch_count/temporal_watch_count_" + file_name + "_" + partySynonymTypeStr + ".png")
            dump_json(
                "../../plots/legislative/walk_based/temporal_watch_count/temporal_watch_count_" + file_name + "_" + partySynonymTypeStr + ".json",
                candidate_dictionary)
            ...
            plt.tight_layout()
            plt.savefig(
                "../../plots/legislative/walk_based/temporal_watch_count/temporal_watch_count_ma7_" + file_name + "_" + partySynonymTypeStr + ".png")
    ...
    if polls_comparison:
        for exp in [Experiments.WELCOME_WALK, Experiments.NATIONAL_NEWS_WALK]:
            ...
            plt.savefig(
                "../../plots/legislative/walk_based/temporal_watch_count/temporal_watch_count_vs_polls_" + file_name + "_" + partySynonymTypeStr + ".png")
            # ----- corr mae etc ---
